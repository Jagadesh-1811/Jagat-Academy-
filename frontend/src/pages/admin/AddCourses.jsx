  ...
  return (
    <div className="max-w-5xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md">
      ...
      <div className="bg-gray-50 p-6 rounded-md">
        ...
        <div className="space-x-2 space-y-2 ">
          {!isPublished ? <button className="bg-black text-white px-4 py-2 rounded-md border border-black" onClick={() => setIsPublished(prev => !prev)}>Click to Publish</button>
            : <button className="bg-white text-black px-4 py-2 rounded-md border border-black" onClick={() => setIsPublished(prev => !prev)}>Click to UnPublish</button>
          }
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className='flex items-center justify-start gap-[15px]'>
            <button className="bg-[#e9e8e8] text-black border-1 border-black cursor-pointer px-4 py-2 rounded-md" onClick={() => navigate("/courses")}>Cancel</button>
