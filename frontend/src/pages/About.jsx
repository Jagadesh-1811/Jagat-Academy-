        ...
        <div className="w-full overflow-hidden bg-white min-h-screen">
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold text-black mb-6 leading-tight">
                                How It All <span className="text-black">Began</span>
                            </h2>
                            ...
                            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                                ...
                                <p>
                                    That's why we built Jagat Academy—a platform where <span className="text-black font-semibold">ambition meets opportunity</span>. We combine cutting-edge AI technology with expert-led instruction to create personalized learning experiences that adapt to each student's unique journey.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="relative">
                            <div className="bg-black rounded-3xl p-10 relative overflow-hidden">
                                <div className="absolute top-0 right-0 w-40 h-40 bg-black/20 rounded-full blur-3xl"></div>

                                <blockquote className="relative">
                                    <div className="text-6xl text-black opacity-50 mb-4">"</div>
                                    ...
                                    <footer className="text-gray-400">
                                        <span className="text-gray-600 font-semibold">— Jagat Academy</span>
                                        <br />
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold text-black mb-4">
                            What We <span className="text-black">Stand For</span>
                        </h2>
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {coreValues.map((value, index) => (
                            <div
                                key={index}
                                className="group bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-gray-800/50 hover:bg-white hover:shadow-lg transition-all duration-500"
                            >
                                <div className="w-12 h-12 bg-black rounded-xl flex items-center justify-center text-white mb-5 group-hover:bg-black transition-colors duration-300">
                                    {value.icon}
                                </div>
            ...
            <section className="py-24 px-6 bg-gray-50">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold text-black mb-4">
                            Why Choose <span className="text-black">Jagat Academy?</span>
                        </h2>
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="group relative bg-white rounded-2xl p-8 border border-gray-200 hover:border-gray-800/30 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl"
                            >
                                <div className="w-14 h-14 bg-black rounded-xl flex items-center justify-center text-white mb-6 group-hover:bg-black transition-colors duration-300">
                                    {feature.icon}
                                </div>
                                ...
                                {/* Accent line */}
                                <div className="absolute bottom-0 left-0 right-0 h-1 bg-black rounded-b-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold text-black mb-4">
                            Your Learning <span className="text-black">Journey</span>
                        </h2>
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                        ...
                        {learningSteps.map((step, index) => (
                            <div key={index} className="relative text-center">
                                <div className="relative z-10 bg-white">
                                    <div className="w-20 h-20 bg-black rounded-2xl flex items-center justify-center text-white mx-auto mb-6 hover:bg-black transition-colors duration-300">
                                        {step.icon}
                                    </div>
                                    <div className="text-black text-sm font-bold mb-2">STEP {step.step}</div>
            ...
            <section className="py-24 px-6 bg-gray-50">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-full mb-6">
                        ...
                        <span className="text-black text-sm font-medium">Our Promise</span>
                    </div>

                    <h2 className="text-4xl md:text-5xl font-bold text-black mb-6">
                        Our Commitment <span className="text-black">To You</span>
                    </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="bg-white rounded-2xl p-6 border border-gray-200">
                            <FaChartLine className="w-8 h-8 text-black mx-auto mb-4" />
                        ...
                        <div className="bg-white rounded-2xl p-6 border border-gray-200">
                            <FaHeadset className="w-8 h-8 text-black mx-auto mb-4" />
                        ...
                        <div className="bg-white rounded-2xl p-6 border border-gray-200">
                            <FaShieldAlt className="w-8 h-8 text-black mx-auto mb-4" />
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="relative bg-black rounded-3xl p-12 md:p-16 overflow-hidden">
                        {/* Gradient overlays */}
                        <div className="absolute top-0 left-0 w-48 h-48 bg-black/20 rounded-full blur-3xl"></div>
                        ...
                        <div className="relative">
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                                Ready to Start Your <span className="text-black">Learning Journey?</span>
                            </h2>
