      ...
      <div className="bg-white shadow-xl rounded-3xl p-6 sm:p-8 w-full max-w-2xl text-center relative">
        ...
        <div className="flex items-center bg-gray-700 rounded-full overflow-hidden shadow-lg relative w-full ">
          ...
          <button
            ...
            className="absolute right-14 sm:right-16 bg-gradient-to-r from-[#CB99C7] to-[#A28FB8] rounded-full w-10 h-10 flex items-center justify-center shadow-lg hover:opacity-90 transition-opacity"
            title="Search with AI"
          >
            <div className="relative">
              <TbSearch className="w-6 h-6 text-white" />
              <TbSparkles className="w-3 h-3 text-white absolute -top-1 -right-1 animate-pulse" />
            </div>
          </button>
