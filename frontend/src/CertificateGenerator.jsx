...
const CertificateGenerator = () => {
  ...
  // New state variables for upload and sharing
  ...
  const shareOnLinkedIn = () => {
    ...
    // Construct LinkedIn post share with pre-filled text (the "matter")
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-4 sm:p-8 font-sans">
      ...
      {/* Controls Panel */}
      <div className="mb-8 bg-gray-800 p-6 rounded-xl shadow-xl w-full max-w-4xl flex flex-col sm:flex-row gap-4 items-center justify-between border border-gray-700">
          ...
          {cloudinaryUrl && (
            <>
              <button 
                ...
                className="px-6 py-2 bg-[#0A66C2] text-white font-semibold rounded-lg shadow-lg hover:opacity-90 transition-opacity whitespace-nowrap flex items-center justify-center gap-2"
              >
              ...
              <button 
                ...
                className="px-6 py-2 bg-transparent border-2 border-[#0A66C2] text-[#0A66C2] font-semibold rounded-lg shadow-lg hover:bg-[#0A66C2] hover:text-white transition-all whitespace-nowrap flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                Add to Profile
              </button>
      ...
      <div ref={certificateRef} className="w-full max-w-5xl aspect-[1.414/1] relative overflow-hidden bg-[#e4e5e7] shadow-2xl rounded-sm print:shadow-none print:w-[1123px] print:h-[794px] print:rounded-none mx-auto flex">
